...
the far left of the histogram.  This happens because there are `r sum(stepsPerDay$totalSteps == 0)` days with a  
...
reduced from `r sum(stepsPerDay$totalSteps < 1000)` to `r sum(impStepsPerDay$totalSteps < 1000)`.
